...
/**
 * Obtains a list of sdk on a pool using [toolchainObtainer], then fills [toolchainComboBox] on the EDT.
 */
@Suppress("UnstableApiUsage")
private fun addToolchainsAsync(toolchainComboBox: RsToolchainPathChoosingComboBox, toolchainObtainer: () -> List<Path>) {
