...
class CustomBuildRunner : RsExecutableRunner(DefaultRunExecutor.EXECUTOR_ID, ERROR_MESSAGE_TITLE) {
    ...
    override fun canRun(executorId: String, profile: RunProfile): Boolean {
        ...
        return true // TODO: я вообще без понятия нормально ли так делать
    }

    // TODO: do something with the environment here later.
    override fun execute(environment: ExecutionEnvironment) {
        ...
        // TODO: do something with the environment here
    ...
    // TODO: Do I need to override doExecute?
...
/*
abstract class RsCustomBuildRunner(
